                                            ...
                                            UNITY_AR_USER_ANCHOR_CALLBACK userAnchorRemovedCallback)
{
    ...
    [nativeSession->_classToCallbackMap setObject:userAnchorCallbacks forKey:(id<NSCopying>)[ARPlaneAnchor class]];
}
                                                ...
                                                UNITY_AR_IMAGE_ANCHOR_CALLBACK imageAnchorRemovedCallback)
{
    if (@available(iOS 11.3, *))
    {
        ...
        [nativeSession->_classToCallbackMap setObject:imageAnchorCallbacks forKey:(id<NSCopying>)[ARPlaneAnchor class]];
    }
}
